...
public class WxArticleListBean {
    ...
    private int size;
    private int total;
    private List<WxArticleListDatasBean> datas;
    ...
    public List<WxArticleListDatasBean> getDatas() {
        return datas;
    }

    public void setDatas(List<WxArticleListDatasBean> datas) {
        this.datas = datas;
    }

    public static class WxArticleListDatasBean {
        /**
         * apkLink : 
         * audit : 1
         * author : 鸿洋
         ...
         * fresh : false
         * id : 12625
         * link : https://mp.weixin.qq.com/s/F0VJyCpOG_CR0edNdbAqPQ
         * niceDate : 2020-03-27 00:00
         * niceShareDate : 2020-03-27 13:15
         * origin : 
         * prefix : 
         * projectLink : 
         * publishTime : 1585238400000
         * selfVisible : 0
         * shareDate : 1585286106000
         * shareUser : 
         * superChapterId : 408
         * superChapterName : 公众号
         * tags : [{"name":"公众号","url":"/wxarticle/list/408/1"}]
         * title : 善于将系统源码为己用，会&ldquo;抄&rdquo;也是技能！
         * type : 0
         * userId : -1
         * visible : 1
         * zan : 0
        ...
        private int visible;
        private int zan;
        private List<WxArticleListTagsBean> tags;
        ...
        public List<WxArticleListTagsBean> getTags() {
            return tags;
        }

        public void setTags(List<WxArticleListTagsBean> tags) {
            this.tags = tags;
        }

        public static class WxArticleListTagsBean {
            /**
             * name : 公众号
